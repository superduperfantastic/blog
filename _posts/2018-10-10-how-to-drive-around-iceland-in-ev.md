...
excerpt: <p>We drove around Iceland in an electric vehicle in a week. How did it go? This is what we learned...</p>
...
comments: false
---
_Honey! For (some $ amount) more we can rent an electric car to drive around Iceland!_

_I've heard something like this before_, I think. _OK, let's do it_

And just like that we decided to drive around Iceland. It seemed like a sensible choice at that time. Gas is expensive there, and Iceland has recently [built an extensive EV charging network](https://cleantechnica.com/2018/05/16/iceland-saturates-its-1300-kilometer-route-1-with-network-of-20-abb-dc-fast-chargers/){:target="_blank"}. Besides, we thought _why would a rental car company provide EV rentals if they didn't think the infrastructure would support it? We'll be fine._
...
We planned on taking the Route 1 Highway - no surprise here, this is the main highway ringing the country, and passes by many sites along the way. You can also see how many charging stations dot the route in the app:
...
The main energy provider in Iceland in [ON Power](http://www.onpower.is/){:target="_blank"} and the one who owns the majority of EV charging stations around the country. They also have a halfway decent app.
...
The rental car company we used, [Geysir](https://www.geysir.is/){:target="_blank"} (A local company) provided us with a [Renault Zoe](https://en.wikipedia.org/wiki/Renault_Zoe){:target="_blank"}. We were expecting it to have a 400km range, as stated in the Wikipedia article since 2016 model years, but for some reason it was the (older?) 240km version. _Uh-oh._
...
At the next station, it was also out of action but waiting for maintenance. _No problem_ we thought, because they still had an AC plug right next to it which should still be working. You see where this is going. The AC plug didn't work either. We coasted into this town with about 20km to spare, neither plugs worked, and we had an appointment for a glacier tour later that day. We. Were. Stuck. 
...
- Call people when in doubt, and make sure you get that SIM card!
- Use all available apps/resources for locating charging stations because you never know which ones will work for you.
- ABC - always be charging.
- Get a longer-range EV that would allow for some longer detours.